...
export function Contact() {
  return (
    <section id="lien-he" className="py-16 md:py-20 bg-black-soft text-white relative overflow-hidden">
      <div className="absolute -right-24 -top-24 h-80 w-80 rounded-full bg-brand/30 blur-2xl" />
      ...
      <div className="container-x relative grid gap-10 lg:grid-cols-2 items-start">
        <div>
          ...
          <h2 className="mt-2 text-2xl md:text-3xl font-extrabold">
            Cần tư vấn thi công sơn bả – chống thấm? Gọi Đào Duy Sơn
          </h2>
          <p className="mt-4 text-white/85 max-w-lg">
            Để lại thông tin, đội kỹ thuật sẽ liên hệ và tới khảo sát miễn phí trong
            vòng 24 giờ tại Hải Phòng – Quảng Ninh – Hà Nội – Hưng Yên – Bắc Ninh – Hà Nam –
            Ninh Bình – Hòa Bình. Ưu đãi giảm 5% cho khách đặt trong tuần này.
          </p>

          <ul className="mt-8 space-y-4">
            <li className="flex items-start gap-3">
              <span className="grid h-11 w-11 flex-none place-items-center rounded-full bg-accent">
            ...
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-lg font-semibold">Hải Phòng &amp; các tỉnh miền Bắc</div>
              </div>
            </li>
          </ul>
        </div>
        ...
        >
          <h3 className="text-xl font-extrabold text-[color:var(--brand-red-dark)]">
          ...
          <div className="mt-5 grid gap-4">
            <div>
              ...
              <input
                type="text"
                required
                className="mt-1 w-full rounded-lg border border-slate-300 px-3 py-2.5 outline-none focus:border-[color:var(--brand-red)]"
            ...
            <div>
              ...
              <select className="mt-1 w-full rounded-lg border border-slate-300 px-3 py-2.5 outline-none focus:border-[color:var(--brand-red)]">
                <option>Sơn bả trọn gói nhà mới xây</option>
                <option>Sửa chữa nhà – sơn lại nhà cũ</option>
                <option>Sơn biệt thự cao cấp</option>
                <option>Thi công thạch cao</option>
                <option>Sơn chống thấm tường, sân thượng</option>
                <option>Sơn chống nóng mái tôn</option>
                <option>Sơn vạch kẻ bãi đậu xe / nhà xưởng</option>
                <option>Sơn epoxy nhà xưởng</option>
                <option>Sơn hiệu ứng – sơn gai – sơn gấm</option>
              </select>
            </div>
            <div>
