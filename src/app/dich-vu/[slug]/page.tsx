          ...
          <div className="container-x grid gap-10 lg:grid-cols-3">
            <article className="lg:col-span-2">
              ...
              <div className="prose prose-slate max-w-none mt-8">
                ...
                <h3 className="mt-8 text-xl font-extrabold text-slate-800 uppercase">
                  Điểm nổi bật
                </h3>
                ...
                <ol className="mt-4 space-y-4">
                  {[
                    ...
                    <li key={i} className="flex gap-4 text-slate-700">
                      <span className="grid h-8 w-8 flex-none place-items-center rounded-full bg-[color:var(--brand-orange)] text-white font-bold text-sm">
                        {i + 1}
                      </span>
            ...
            <aside className="lg:col-span-1 space-y-6">
              <div className="rounded-2xl border border-slate-200 bg-[color:var(--muted)] p-6">
                ...
                <Link
                  href="/lien-he"
                  className="mt-3 block text-center rounded-full border-2 border-[color:var(--brand-green)] px-5 py-2 font-semibold text-[color:var(--brand-green)] hover:bg-[color:var(--brand-green)] hover:text-white transition"
                >
                  Gửi yêu cầu online
                </Link>
              </div>
                ...
                <ul className="mt-3 space-y-2">
                  {others.map((o) => (
                    <li key={o.slug}>
                      <Link
                        href={`/dich-vu/${o.slug}`}
                        className="flex items-start gap-2 text-sm text-slate-700 hover:text-[color:var(--brand-green)]"
                      >
                        <span className="mt-1 text-[color:var(--brand-orange)]">→</span>
